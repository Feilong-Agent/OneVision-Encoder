...
def main():
    ...
    args.list_loss_weight = [float(x) for x in args.list_loss_weight]
    if len(args.list_loss_weight) == 1:
        args.list_loss_weight = args.list_loss_weight * args.num_head
    ...
    while not end_of_batch:
        ...
        for head_id, dataset_config in enumerate(args.list_dataset):
            ...
            if dataset_config.dali_type in ["decord"]:
                ...
                with torch.amp.autocast(dtype=torch.bfloat16, device_type="cuda"):
                    head_embedding = backbone(head_input)["visible_embeddings"]
        ...
        for head_id, pfc in enumerate(list_module_pfc):
            ...
            if dataset_config.dali_type == "det":
                ...
                head_label = head_label.view(-1,full_label_num)[
            ...
            head_loss = pfc(head_embedding, head_label, random_diff) * loss_weight if head_id ==0 else pfc(head_embedding, head_label[:,0]) * loss_weight
