...
parser.add_argument(
    "--init_encoder", default="/vlm/xiangan/VideoMLCD/checkpoints/llava_vit_s_16.py/00160000/backbone.pt",
...
TEACHER_MODEL_PATH = {
    ...
    "pretrain_encoder_small_patch16_224_v10_12_rms_unmask_with_head": "/vlm/xiangan/VideoMLCD/checkpoints/llava_vit_s_16.py/00160000/backbone.pt",
}
    ...
    while global_step < args.total_steps:
        ...
        for head_id, dataset_config in enumerate(args.list_dataset):
            ...
            with torch.amp.autocast(dtype=torch.bfloat16, device_type="cuda"):
                ...
                student_embedding = visible_embeddings
            ...
            loss_now = mse_loss(teacher_output, student_embedding) * 0.1
            teacher_future = teacher_output[:, teacher_output.shape[1]//t:, :]
            decoded_full = decoded_full[:, :-(decoded_full.shape[1]//t), :]

            loss_future = mse_loss(decoded_full, teacher_future)
            loss = loss_now + loss_future
