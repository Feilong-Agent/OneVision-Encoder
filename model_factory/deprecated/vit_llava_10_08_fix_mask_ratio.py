...
__all__ = [
    "pretrain_encoder_small_patch16_224_v10_08_rms_unmask",
]
...
@register_model
def pretrain_encoder_small_patch16_224_v10_08_rms_unmask(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
...
@register_model
def pretrain_encoder_base_patch16_224_v10_08_rms_unmask(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
    ViT Encoder for Video MAE-style pretraining."""
    model = LlavaViTEncoder(
        patch_size=16,
