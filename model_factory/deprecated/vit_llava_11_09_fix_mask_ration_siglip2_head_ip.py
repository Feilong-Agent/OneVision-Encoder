...
__all__ = [
    "pretrain_encoder_small_patch16_224_v11_09_rms_head_ip"
]
...
@register_model
def pretrain_encoder_small_patch16_224_v11_09_rms_head_ip(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
...
@register_model
def pretrain_encoder_base_patch16_224_v11_09_rms_head_ip(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
    ViT Encoder for Video MAE-style pretraining."""
    model = LlavaViTEncoder(
        patch_size=16,
...
@register_model
def pretrain_encoder_base_patch16_224_v11_09_ln_head_ip(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
    ViT Encoder for Video MAE-style pretraining."""
    model = LlavaViTEncoder(
        patch_size=16,
...
@register_model
def pretrain_encoder_large_patch14_224_v11_09_rms_head_ip(pretrained: bool = False, ckpt_path=None,**kwargs):
    """
    ViT Encoder for Video MAE-style pretraining."""
    model = LlavaViTEncoder(
        patch_size=14,
