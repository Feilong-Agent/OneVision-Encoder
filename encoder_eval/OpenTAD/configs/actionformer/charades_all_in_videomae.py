...
args = argparse.ArgumentParser("传参")
args.add_argument("--feature_path", default="../_base_/datasets/charades/features_videomae_base.py")
args.add_argument("--inchannels", default=784)
args.add_argument("--save_dir", default="exps/charades/actionformer_videomae_B")
args = args.parse_args()


_base_ = [
    # "../_base_/datasets/charades/feature_videomae_large.py",  # dataset config
    args.feature_path,
