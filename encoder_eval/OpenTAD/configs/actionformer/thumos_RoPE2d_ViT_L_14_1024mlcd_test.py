...
_base_ = [
    "../_base_/datasets/thumos/feature_RoPE2d_ViT_L_14_1024mlcd_test.py",  # dataset config
    "../_base_/models/actionformer.py",  # model config
]

model = dict(projection=dict(in_channels=768, input_pdrop=0.2))
...
work_dir = "exps/thumos/actionformer_RoPE2d_ViT_L_14_1024mlcd_test"
