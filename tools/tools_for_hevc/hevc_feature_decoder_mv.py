...
class RobustHevcStream:
    ...
    def __init__(self, video, parallel=1, hevc_bin=None):
        ...
        self.hevc_bin = hevc_bin or os.environ.get('HEVC_FEAT_DECODER', '/video_vit/umt/umt_split/decoder/bin/hevc')
...
_HEVC_FEAT_DECODER = os.environ.get('HEVC_FEAT_DECODER', '/video_vit/umt/umt_split/decoder/bin/hevc')
