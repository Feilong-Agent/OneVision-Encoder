...
CKPT_PATH=/video_vit/xiangan/checkpoint_llava_vit/continue_with_mlcd_1536_tokens_b16_mix_three_input_residual_mv/00078126/backbone.pt
...
OUTPUT_DIR=three_input_b16_mv_residual_mv
