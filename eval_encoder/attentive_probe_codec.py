...
def parse_args() -> argparse.Namespace:
    ...
    # Data
    parser.add_argument("--data_root", default="/video_vit/feilong/LLaVA-ViT/eval_encoder")
    ...
    parser.add_argument("--dataset", default="COIN")
...
def evaluate(
    ...
    for i, batch in enumerate(loader_val):
        ...
        for crop_id in range(num_crops):
            feats = get_feature(args, videos[:, crop_id], base_model, frame_indices=indices[:, crop_id], visible_indices = visible_indices,  total_frames=total_frames, is_training=False)
            with torch.cuda.amp.autocast(dtype=torch.bfloat16):
...
def main() -> None:
    args = parse_args()
    nb_classes_map = {"charadesego": 157, "CharadesEgo_v1_only3rd": 157, "Drone_Action": 13, "epic_noun": 300, "hmdb51": 51, "k400": 400, "k700": 700, "mit": 339, "rareact": 149, "ucf101": 101, "CharadesEgo_v1_only1st": 157, "diving48": 48, "epic_verb": 97, "k600": 600, "k710": 710, "perception_test": 63, "ssv2": 174, "SSV2": 174, "COIN": 150}
