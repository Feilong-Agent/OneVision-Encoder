...
root = "/mnt/linear_probe_dataset/rec/resisc45"
root = f"{os.environ['LINEAR_PROBE_ROOT']}/resisc45"

num_example_train = 3150
num_example_test = 25200
num_example_other = 3150
num_classes = 45
