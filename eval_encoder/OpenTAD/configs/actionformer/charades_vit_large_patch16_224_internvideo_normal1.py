...
_base_ = [
    "../_base_/datasets/charades/feature_vit_large_patch16_224_internvideo_normal1.py",
...
work_dir = "exps/charades/actionformer_vit_large_patch16_224_internvideo_normal1"
