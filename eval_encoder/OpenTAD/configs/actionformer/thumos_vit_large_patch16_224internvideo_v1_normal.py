...
_base_ = [
    "../_base_/datasets/thumos/feature_vit_large_patch16_224internvideo_v1_normal.py",  # dataset config
    "../_base_/models/actionformer.py",  # model config
]

model = dict(projection=dict(in_channels=1024, input_pdrop=0.2))
...
work_dir = "exps/thumos/actionformer_vit_large_patch16_224internvideo_v1_normal"
