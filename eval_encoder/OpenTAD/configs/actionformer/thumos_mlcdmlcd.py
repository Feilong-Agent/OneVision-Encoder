...
_base_ = [
    "../_base_/datasets/thumos/feature_mlcdmlcd.py",  # dataset config
    "../_base_/models/actionformer.py",  # model config
]

model = dict(projection=dict(in_channels=1664, input_pdrop=0.2))
...
work_dir = "exps/thumos/actionformer_mlcdmlcd"
