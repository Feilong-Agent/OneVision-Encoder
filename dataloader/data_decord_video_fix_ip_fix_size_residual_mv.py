...
class ExternalInputCallable:
    ...
    def get_label_and_visible_indices(self, video_path):
        ...
        video_visible_indices_path = video_path.replace("clips_square_aug_k710_ssv2_hevc_v2", "clips_square_aug_k710_ssv2_hevc_v2_residual_mv")
    ...
    def __call__(self, sample_info):
        ...
        try:
            ...
            print("Error loading video:" , video_path)
            print(e)
            video_path, video_label, video_visible_indices = random_try_path()
            video_data = self.sparse_sampling_get_frameid_data(video_path, self.sequence_length, test_info)
