...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --init_backbone /video_vit/xiangan/checkpoint_llava_vit/continue_l14/00117188/backbone.pt \
  --list_init_partial_fc_paths /video_vit/xiangan/checkpoint_llava_vit/continue_l14/00117188/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt \
  --output /video_vit/xiangan/checkpoint_llava_vit/`basename $0 .sh` \
  --num_sampled_data 1_200_000_000
