...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --master_port 29508 --nproc_per_node 8 -m training.train_univit_10_31_ip \
  --model_name pretrain_encoder_small_patch16_224_v10_29_rms_head_ip \
  --list_batch_sizes 64 64 \
  --lr 1e-4 \
  --list_datasets k710_ssv2_univit_pfs_ip_path mlcd_coyo_laion \
  ...
  --output /video_vit/feilong/Check_Code/LLaVA-ViT/checkpoints/bidir_IP_10_29_fix_IP_path_test \
