...
# /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain/00394000/backbone.pt
# /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain/00394000/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt
...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --init_backbone /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain/00394000/backbone.pt \
  --list_init_partial_fc_paths /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain/00394000/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt \
  --output /video_vit/xiangan/checkpoint_llava_vit/`basename $0 .sh` \
  --num_sampled_data 13_000_000_00 \
