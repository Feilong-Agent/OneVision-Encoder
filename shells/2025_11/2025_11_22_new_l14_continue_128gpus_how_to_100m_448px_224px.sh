...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  -m \
  training.train_univit_11_22_l14_448_sampling_how_to_100M \
  ...
  --init_backbone /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain_continue_448px/00158692/backbone.pt \
  --list_init_partial_fc_paths /video_vit/xiangan/checkpoint_llava_vit/new_l14_mlcd_pretrain_continue_448px/00158692/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt NULL  \
