...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --model_name llava_vit_large_rms \
  --embedding_size 1024 \
  --list_batch_sizes 256 \
  --lr 0.00016 \
  --warmup_ratio 0.001 \
  --list_datasets llava_vit_si_ssd \
  --init_backbone /vlm/xiangan/VideoMLCD/checkpoints/llava_vit_l_14_224px_continue.py/00160000/backbone.pt \
  --list_init_partial_fc_paths /vlm/xiangan/VideoMLCD/checkpoints/llava_vit_l_14_224px_continue.py/00160000_80gpus/coyo_laion_%03d.npy \
  --output /video_vit/xiangan/checkpoint_llava_vit/`basename $0 .sh` \
  --num_sampled_data 2_400_000_000
