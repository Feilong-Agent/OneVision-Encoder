...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --list_init_partial_fc_paths /video_vit/xiangan/checkpoint_llava_vit/new_b16_mlcd_pretrain/00253907/llava_vit_si_ssd_128gpus/llava_vit_si_ssd_%03d.npy NULL  \
