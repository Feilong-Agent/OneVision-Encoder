...
root_pfc=/video_vit/xiangan/checkpoint_llava_vit/2025_12_02_new_l14_continue_128gpus_how_to_100m_448px_224px_num_frames_16_huggingface/00226000/
path_llava_vit_si_ssd=${root_pfc}/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt
path_configs_for_llava_vit_versions_0_0_2_add_pandas70M=${root_pfc}/configs_for_llava_vit_versions_0_0_2_add_pandas70M/configs_for_llava_vit_versions_0_0_2_add_pandas70M_%03d.pt
...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --embedding_size 1024 \
  --list_batch_sizes 16 24 16 \
  --lr 0.00005 \
  --warmup_ratio 0.001 \
  --list_datasets llava_vit_ocr_ssd llava_vit_si_ssd configs_for_llava_vit_versions_0_0_2_add_pandas70M_filtered  \
  --output /video_vit/xiangan/checkpoint_llava_vit/`basename $0 .sh` \
  --init_backbone /video_vit/xiangan/checkpoint_llava_vit/2025_12_02_new_l14_continue_128gpus_how_to_100m_448px_224px_num_frames_16_huggingface/00226000_hf \
  --list_init_partial_fc_paths NULL $path_llava_vit_si_ssd $path_configs_for_llava_vit_versions_0_0_2_add_pandas70M \
  --list_sample_rates 0.1 0.1 0.1 \
  --list_lr_pfc_weights 5 1 1 \
