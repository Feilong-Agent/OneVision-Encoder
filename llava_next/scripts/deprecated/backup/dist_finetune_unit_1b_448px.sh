...
VISION_MODEL_VERSION="/vlm/pretrain_models/UNIT/UNIT_1B_448px"
VISION_MODEL_VERSION_CLEAN="${VISION_MODEL_VERSION//\//_}"
DATA_ROOT="/vlm/data/train_images"
PROJECTOR_NAME="llavanext-_vlm_pretrain_models_UNIT_UNIT_1B_448px-_vlm_pretrain_models_Qwen_Qwen2.5-7B-Instruct-mlp2x_gelu-pretrain_blip558k_plain"

PROMPT_VERSION="qwen_1_5"


BASE_RUN_NAME="llavanext-unit-448px-qwen2.5-mlp2x_gelu-pretrain_blip558k-finetune_llavanext780k-8nodes"
