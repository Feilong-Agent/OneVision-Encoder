...
PROJECTOR_NAME="llavanext-_vlm_xiangan_pretrain_models_deepglint_rice-vit-large-patch14-560-v1-_vlm_pretrain_models_Qwen_Qwen2.5-7B-Instruct-mlp2x_gelu-pretrain_blip558k_plain"
PROMPT_VERSION="qwen_1_5"


mm_projector_type="patch_merger"
BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-${mm_projector_type}-pretrain_blip558k-emova-alignment-7m-finetune_llavanext780k-14nodes-4x4"
