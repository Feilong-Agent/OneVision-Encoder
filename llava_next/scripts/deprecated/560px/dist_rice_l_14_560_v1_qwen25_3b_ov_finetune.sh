...
PROJECTOR_NAME="llavanext-_vlm_xiangan_pretrain_models_deepglint_rice-vit-large-patch14-560-v1-_vlm_pretrain_models_Qwen_Qwen2.5-3B-Instruct-mlp2x_gelu-pretrain_blip558k_plain"
PROMPT_VERSION="qwen_1_5"


BASE_RUN_NAME="one_vision_llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k-finetune_llavanext780k-14nodes"
...
deepspeed --hostfile list_host_v12 \
    ...
    --data_path /mnt/vlmdata/data/finetune_data/onevision_robot_3871k.json \
    --image_folder "/mnt/vlmdata/data/train_images" \
    ...
    --mm_vision_select_feature patch_interpolate 
