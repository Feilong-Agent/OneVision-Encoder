...
LLM_VERSION="/vlm/pretrain_models/Qwen/Qwen3-4B-Instruct-2507"
...
BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-spatial_merge-pretrain_blip558k_plain"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

deepspeed --hostfile host_128 \
