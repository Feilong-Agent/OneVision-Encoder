...
PROJECTOR_NAME="hevc_vit_flashattn_qwen25"
PROMPT_VERSION="qwen_1_5"


BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k-finetune_llavanext780k-10nodes_v2"
