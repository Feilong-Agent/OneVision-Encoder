...
PROJECTOR_NAME="llavanext-_vlm_xiangan_pretrain_models_deepglint_RICE_rice-vit-large-patch14-378-v4-_vlm_pretrain_models_Qwen_Qwen2.5-7B-Instruct-mlp2x_gelu-pretrain_blip558k_plain"

PROMPT_VERSION="qwen_1_5"


BASE_RUN_NAME="llavanext-RICE-vit-l-14-378px-v4-qwen2.5-mlp2x_gelu-pretrain_blip558k-finetune_llavanext780k-8nodes"
