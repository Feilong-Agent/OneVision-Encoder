...
class AIMv2560pxVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = AIMv2Config.from_pretrained(self.vision_tower_name)

        self.num_patches_per_side = 560 // 14
    ...
    def load_model(self, device_map=None):
        ...
        self.vision_tower = AIMv2Model.from_pretrained(self.vision_tower_name, device_map=device_map)
...
class AIMv2560pxVisionTowerS2(AIMv2560pxVisionTower):
    def __init__(self, vision_tower, args, delay_load=False):
