...
from .eva_8B_448px.model import EvaCLIPVisionModel, EvaCLIPVisionConfig
try:
...
class EVA_8B_448px_VisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.vision_tower = EvaCLIPVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map)
...
class EVA_8B_448px_VisionTowerS2(EVA_8B_448px_VisionTower):
    def __init__(self, vision_tower, args, delay_load=False):
