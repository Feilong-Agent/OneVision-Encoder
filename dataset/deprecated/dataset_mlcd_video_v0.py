...
if os.environ["HOSTNAME"] in \
    ...
    _mlcd_video_n1_v0_20k = Property(
        ...
        num_shards=2,            # 数据分片数 (Number of data shards)
        shard_id=local_rank % 2, # 当前进程使用的分片ID (Shard ID used by current process)
