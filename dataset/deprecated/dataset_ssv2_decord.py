...
list_prefix = []
if os.path.exists("/data_2/video_dataset/ssv2_train_new.csv"):


    with open("/data_2/video_dataset/ssv2_train_new.csv", "r") as f:
        lines = f.readlines()
...
_mlcd_ssv2_decord = Property(
    num_class=173,
    num_example=0,
    name="mlcd_ssv2_decord",
    prefix=list_prefix,
...
def mlcd_ssv2_decord():
    return _mlcd_ssv2_decord
