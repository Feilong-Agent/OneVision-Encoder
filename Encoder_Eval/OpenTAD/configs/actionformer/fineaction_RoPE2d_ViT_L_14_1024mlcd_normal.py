...
_base_ = [
    "../_base_/datasets/fineaction/feature_RoPE2d_ViT_L_14_1024mlcd_normal.py",  # dataset config
...
post_processing = dict(
    ...
    external_cls=dict(
        ...
        path="/video_vit/TAD-Dataset/fineaction/classifiers/new_swinB_1x1x256_views2x3_max_label_avg_prob.json",
        topk=2,
    ),
    save_dict=False,
)
...
work_dir = "exps/fineaction/actionformer_RoPE2d_ViT_L_14_1024mlcd_normal"
