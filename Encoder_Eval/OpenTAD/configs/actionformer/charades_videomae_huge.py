_base_ = [
    "../_base_/datasets/charades/feature_videomae_huge.py",  # dataset config
    # "../_base_/datasets/charades/features_videomae_train_trunc_test_sw_s4.py",
...
solver = dict(
    train=dict(batch_size=16, num_workers=0),
    val=dict(batch_size=16, num_workers=0),
    test=dict(batch_size=16, num_workers=0),
    clip_grad_norm=1,
    ema=True,
)
...
work_dir = "exps/charades/actionformer_videomae_huge"
