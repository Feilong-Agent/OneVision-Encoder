...
_base_ = [
    "../_base_/datasets/fineaction/feature_vit_large_patch16_224internvideo1_normal.py",  # dataset config
...
work_dir = "exps/fineaction/actionformer_vit_large_patch16_224internvideo1_normal"
